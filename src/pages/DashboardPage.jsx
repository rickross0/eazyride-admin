...
export default function DashboardPage() {
  ...
  const cards = [
    { label: 'Total Users', value: stats.users, color: '#FFD700' },
...
const styles = {
  ...
  link: { display: 'block', background: '#0F0F0F', border: '1px solid #2A2A2A', borderRadius: 10, padding: 16, color: '#FFD700', textDecoration: 'none', fontWeight: 600, textAlign: 'center' },
};
