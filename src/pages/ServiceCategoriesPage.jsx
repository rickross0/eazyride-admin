...
const EMPTY_CATEGORY = {
  name: '', description: '', emoji: '', color: '#FFD700', slug: '',
...
export default function ServiceCategoriesPage() {
  ...
  const openEdit = (cat) => {
    ...
    setForm({
      ...
      color: cat.color || '#FFD700', slug: cat.slug || '',
          ...
          <tbody>
            {filtered.length === 0 ? (
              ...
              <tr key={cat.id}>
                ...
                <td style={styles.td}>
                  <span style={{ ...styles.colorDot, background: cat.color || '#FFD700' }} />
...
const styles = {
  ...
  addBtn: { background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 10, padding: '10px 24px', cursor: 'pointer', fontWeight: 700, fontSize: 14 },
  ...
  toggleOn: { background: '#FFD70022', color: '#34C759', borderColor: '#34C759' },
