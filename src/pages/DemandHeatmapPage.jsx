    ...
    <div>
      ...
      <div style={styles.statsRow}>
        <div style={styles.statCard}>
          <div style={{ ...styles.statValue, color: '#FFD700' }}>{totalRides}</div>
      ...
      <div style={{ position: 'relative' }}>
        ...
        {hoveredPoint && (
          <div style={{
            ...
            <div style={{ color: '#FFD700', fontSize: 11 }}>🛺 {Math.round(hoveredPoint.rides)} rides</div>
              ...
              <tbody>
                {hotspots.map((p, i) => (
                  <tr key={i}>
                    ...
                    <td style={{ ...styles.td, color: '#FFD700' }}>{Math.round(p.rides)}</td>
...
const styles = {
  ...
  rangeBtnActive: { background: '#FFD700', color: '#FFF', borderColor: '#FFD700' },
