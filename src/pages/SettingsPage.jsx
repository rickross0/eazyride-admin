...
const styles = {
  ...
  card: { background: '#1A1A1A', borderRadius: 14, padding: 24, marginBottom: 20, borderTop: '3px solid #FFD700' },
  ...
  saveBtn: { background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 8, padding: '10px 20px', fontWeight: 700, cursor: 'pointer', fontSize: 14 },
