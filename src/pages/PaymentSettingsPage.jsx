    ...
    <div style={styles.container}>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.field}>
          ...
          <div style={styles.toggleRow}>
            <button style={evcConfig.mode === 'test' ? styles.toggleActive : styles.toggle} onClick={() => setEvcConfig({ ...evcConfig, mode: 'test' })}>Test</button>
            <button style={evcConfig.mode === 'live' ? styles.toggleActive : styles.toggle} onClick={() => setEvcConfig({ ...evcConfig, mode: 'live' })}>Live</button>
          </div>
        </div>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.field}>
          <label style={styles.label}>Mode</label>
          <div style={styles.toggleRow}>
            <button style={zaadConfig.mode === 'test' ? styles.toggleActive : styles.toggle} onClick={() => setZaadConfig({ ...zaadConfig, mode: 'test' })}>Test</button>
            <button style={zaadConfig.mode === 'live' ? styles.toggleActive : styles.toggle} onClick={() => setZaadConfig({ ...zaadConfig, mode: 'live' })}>Live</button>
          </div>
        </div>
