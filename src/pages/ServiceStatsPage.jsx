...
const CHART_COLORS = ['#FFD700', '#007AFF', '#FF9500', '#5856D6', '#FF3B30', '#AF52DE', '#00C7BE', '#FFD60A', '#FF6B6B', '#64D2FF'];
...
export default function ServiceStatsPage() {
  ...
  const kpis = [
    { label: 'Total Users', value: stats.totalUsers ?? 0, trend: stats.usersTrend, color: '#FFD700', icon: '👥' },
