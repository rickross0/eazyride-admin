    ...
    <div>
      ...
      <div style={styles.statsGrid}>
        <div style={styles.statCard}>
          <div style={{ ...styles.statValue, color: '#FFD700' }}>${(data.rideRevenue || 0).toFixed(2)}</div>
      ...
      <div style={{ marginTop: 32 }}>
            ...
            allDates.map((date) => (
              <div key={date} style={styles.barGroup}>
                <div style={styles.barRow}>
                  <div style={{ ...styles.bar, height: ((rideMap[date] || 0) / maxDaily) * 100, background: '#FFD700' }} />
        ...
        <div style={styles.legend}>
          <span style={styles.legendItem}><span style={{ ...styles.legendDot, background: '#FFD700' }} /> Rides</span>
...
const styles = {
  ...
  exportBtn: { background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 8, padding: '10px 20px', cursor: 'pointer', fontWeight: 700, fontSize: 13 },
