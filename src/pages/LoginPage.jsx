...
const styles = {
  ...
  title: { color: '#FFD700', fontSize: 32, fontWeight: 800, margin: '0 0 0', letterSpacing: -1 },
  ...
  button: { width: '100%', background: 'linear-gradient(135deg, #FFD700 0%, #0DBF65 100%)', color: '#FFF', border: 'none', borderRadius: 10, padding: 14, fontSize: 16, fontWeight: 700, cursor: 'pointer', marginTop: 8, transition: 'opacity .2s' },
