...
const styles = {
  ...
  successBtn: { background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 8, padding: '6px 14px', cursor: 'pointer', fontWeight: 700, fontSize: 13 },
  ...
  roleOptionActive: { border: '2px solid #FFD700', background: '#FFD70022' },
};
