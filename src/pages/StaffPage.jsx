              ...
              <div key={group.group} style={styles.permGroup}>
                ...
                {group.perms.map((p) => (
                  <div key={p.key} style={styles.permRow} onClick={() => togglePerm(p.key)}>
                    <div style={{ ...styles.toggleIndicator, background: staffPerms[p.key] ? '#FFD700' : '#333' }}>
                      {staffPerms[p.key] ? '✓' : '—'}
                    </div>
...
const styles = {
  ...
  addBtn: { background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 10, padding: '10px 24px', fontWeight: 700, cursor: 'pointer', fontSize: 14 },
  ...
  saveBtn: { background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 8, padding: '10px 24px', fontWeight: 700, cursor: 'pointer', fontSize: 14 },
  ...
  successSmBtn: { background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 6, padding: '4px 10px', cursor: 'pointer', fontWeight: 700, fontSize: 12 },
  ...
  savePermBtn: { background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 8, padding: '12px 32px', fontWeight: 700, cursor: 'pointer', fontSize: 15 },
};
