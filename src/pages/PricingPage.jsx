...
const styles = {
  ...
  cardTitle: { color: '#FFD700', fontSize: 18, fontWeight: 800, margin: '0 0 16px' },
  ...
  saveBtn: { width: '100%', background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 8, padding: 12, fontSize: 15, fontWeight: 700, cursor: 'pointer', marginTop: 8 },
};
