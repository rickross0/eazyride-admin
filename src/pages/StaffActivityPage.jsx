...
const styles = {
  ...
  filterBtn: { background: '#FFD700', color: '#FFF', border: 'none', borderRadius: 8, padding: '10px 20px', fontWeight: 700, cursor: 'pointer', fontSize: 14 },
...
const expandedStyles = {
  ...
  section: { minWidth: 0 },
  sectionTitle: { color: '#FFD700', fontSize: 13, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 8 },
