  ...
  return (
    <div>
      ...
      <div style={styles.statsRow}>
        ...
        <div style={styles.statCard}>
          <div style={{ ...styles.statValue, color: '#FFD700' }}>{drivers.length}</div>
...
const styles = {
  ...
  selectedRow: { background: '#FFD70022' },
  detailCard: { background: '#1A1A1A', borderRadius: 14, padding: 24, marginTop: 24 },
  detailTitle: { fontSize: 16, fontWeight: 700, color: '#FFD700', marginBottom: 12 },
